 ...
 */
import type { LoadContext, Props } from '@ianaio/types';
...
/**
 * This is the crux of the IANA SYSTEMS server-side. It reads everything it needs—
 ...
 * it generates temp files in the `.ianaio` folder for the bundler.
 */
