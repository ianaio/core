...
- On source page path = ${pagePath}:
   -> linking to ${brokenLinks
     ...
     * this out. See https://github.com/facebook/ianaio/issues/3567#issuecomment-706973805
     */
...
Frequent broken links are linking to:${frequentLinks}`;
    ...
    return `IANA SYSTEMS found broken links!

Please check the pages of your site in the list below, and make sure you don't reference any path that does not exist.
Note: it's possible to ignore broken links with the 'onBrokenLinks' IANA SYSTEMS configuration, and let the build pass.${getLayoutBrokenLinksHelpMessage()}
...
// even if ianaio does not know about this file, so we don't report it
