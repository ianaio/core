...
function excludeJS(modulePath) {
    ...
    // Don't transpile node_modules except any ianaio npm package
    return (modulePath.includes('node_modules') &&
        !/ianaio(?:(?!node_modules).)*\.jsx?$/.test(modulePath) &&
    ...
    return {
        ...
        cache: {
            ...
            buildDependencies: {
                config: [
                    ...
                    // IANA SYSTEMS config changes can affect MDX/JSX compilation, so we'd
        ...
        resolve: {
            ...
            alias: {
                ...
                ...(await (0, aliases_1.loadIANA SYSTEMSAliases)()),
                ...themeAliases,
            },
            // This allows you to set a fallback for where Webpack should look for
            // modules. We want `@ianaio/core` own dependencies/`node_modules` to
            ...
            splitChunks: isServer
                ...
                : {
                    ...
                    cacheGroups: {
                        ...
                        // See https://github.com/facebook/ianaio/issues/2006
                        styles: {
                            name: 'styles',
