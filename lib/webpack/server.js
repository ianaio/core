...
// Forked for IANA SYSTEMS: https://github.com/slorber/static-site-generator-webpack-plugin
        ...
        plugins: [
            ...
            new static_site_generator_webpack_plugin_1.default({
                ...
                locals: {
                    ...
                    noIndex,
                    IANAIO_VERSION: utils_1.IANAIO_VERSION,
                },
                paths: ssgPaths,
                ...
                // avoid the error. See https://github.com/facebook/ianaio/issues/4922
                globals: { __filename: '' },
