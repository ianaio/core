...
exports.loadIANA SYSTEMSAliases = exports.loadThemeAliases = exports.createAliasesForTheme = exports.sortAliases = void 0;
 ...
 * aliases instead.
 */
async function loadIANA SYSTEMSAliases() {
    ...
    (await fs_extra_1.default.readdir(dirPath))
        ...
        const aliasName = `@ianaio/${fileNameWithoutExtension}`;
        aliases[aliasName] = path_1.default.resolve(dirPath, fileName);
    });
    return aliases;
}
exports.loadIANA SYSTEMSAliases = loadIANA SYSTEMSAliases;
